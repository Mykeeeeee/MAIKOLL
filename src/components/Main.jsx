  ...
  return (
    <main>
      ...
      <section className="extern-links-section">
        <ul>
          <li>
           <a href="#"><img src="http://cine.ar/img/tv.cine.ar.svg" alt="meganashe" style={{width: 300, height: 61}} />
           </a>
          </li>
          <li>
           <a href="#"><img src="http://cine.ar/img/play.cine.ar.svg" alt="nashe" style={{width: 300, height: 61}}/>
           </a>
         </li>
         <li>
           <a href="#"><img src="http://cine.ar/img/estrenos.cine.ar.svg" alt="ashe" style={{width: 300, height: 61}}/>
           </a>
        </li>
        </ul>
      </section>
